...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
	...
	<script>
		...
		function Validate(){
			var f = eval("document.boardDelete");
			if(f.pass.value==""){
				alert("패스워드를 입력해주세요");
				f.pass.focus();
				return false;
			...
			$.ajax({
				...
				data : { idx : $('#idx').val()},
				dataType : "json",
				success : function fucFunc(d){
					alert("삭제되었습니다.");
					window.opener.location.replace("./list.do");
					window.close();
				},
...
<div class="container">
	...
	<input type="hidden" name="idx" id="idx" value=${viewDel.num } />
	<input type="hidden" name="pass" id="pass" value=${viewDel.pass } />
	<div class="row">
		<div class="col-2"></div>
		<div class="col-6">
